...
% \cite{Apostol1976, CLRS2009, Cohen1993, Diamond1982, GM1978, Levinson1969, Pritchard1981, Pritchard1982, Pritchard1983, Pritchard1987, Selberg1949}
...
\begin{proof}
  ...
  Al inmiscuir \Cref{lem:2xlnx-ox}, esta relaci\'on se troca por
  \[
  ...
  \[
    2x\ln x + O(x) = (\vartheta(x) + O(\sqrt{x}\ln x))\ln x + \sum_{p \leq x} \vartheta\left(\frac{x}{p}\right)\ln p \\  
  \]
