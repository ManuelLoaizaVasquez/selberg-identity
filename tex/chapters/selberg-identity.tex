...
\begin{proof}
  Usaremos el desarrollo de los estimados de Chebyshev de \cite{Diamond1982} dado por
  \[
...
\begin{proof}
  ...
  Utilizamos la desigualdad triangular junto con el hecho de que se cumple
...
trabajaron el \cref{lem:psi-2xlnx-ox} mediante integrales.
Nosotros hemos evitado aquello astutamente haciendo
uso de la desigualdad triangular.
